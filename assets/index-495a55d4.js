...
void main()
{
    ...
    float strength = step(0.9, mod(vUv.x * 8.0, 1.0));
    strength += step(0.9, mod(vUv.y * 8.0, 1.0));
...
//# sourceMappingURL=index-495a55d4.js.map
